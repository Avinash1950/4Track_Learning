...
const Home = () => {
  ...
  return (
    <div>
      <div className="background-image" style={sliderContainerStyle}>
          <img src="images/poster1.jpeg" alt="" style={picStyle} className="pic" />
          <img src="images/poster2.jpeg" alt="" style={picStyle} className="pic" />
          <img src="images/poster3.jpeg" alt="" style={picStyle} className="pic" />
          <img src="images/poster4.jpeg" alt="" style={picStyle} className="pic" />
      </div>

      <div className="service-container">
        <div className="service-header">
          <h2>
            <span style={{ color: "#236082" }}>Our Services</span>
          </h2>
        </div>
      ...
      <div className="finders">
        <h2>Exclusive Immigration Tool by 4TRACK LEARNING</h2>
      ...
      <div className="flex-item">
        <div className="form-reg">
          <form method="POST" action="/regis">
            <fieldset>
              <legend>
                <b style={{ fontSize: "26px", color: "#236082" }}>
  ...
  <option value="The Nilgiris">The Nilgiris</option>
        ...
        <div className="display-item">
          <h1 style={{ color: "#236082", textAlign: "center" }}>
            Call us Now..!!
          </h1>
          <div className="flag">
            <img
