...
const Destinations = () => {
  ...
  return (
    ...
    <h1 className="glow" style={sectionStyle}>
          <span style={glowStyle}> </span> Our Destinations
        </h1>
        <h2 style={{ display: 'block', color: 'black', textAlign: 'center' }}>
          <span style={{ color: '#236082' }}>Graduate</span> from your dream country...
        </h2>
        <br />
        ...
        <div className="info">
            <h1 style={{ fontSize: '24px', backgroundColor: '#236082', textAlign: 'center' }}>Where to Study...?Is that a doubt
            </h1>
