...
// }
  ...
  return (
    <div>
      ...
      <section>
        <h2 style={{ textAlign: 'center', color: '#236082' }}>Select Your Country</h2>
        ...
        <div className="flex-item">
          <div className="form-reg">
            <form method="get">
              <fieldset>
                <legend>
                  <b style={{ fontSize: '26px', color: '#236082' }}>Fill the Registration Form</b>
                </legend>
          ...
          <div className="display-item">
            <h1 style={{ color: '#236082', textAlign: 'center' }}>Call us Now..!!</h1>
            <div className="flag">
