...
const Resource = () => {
  ...
  return (
    <div>
      ...
      <nav>
        <ul>
          <li><a href="#blog">Student Testimonials</a></li>
      ...
      <section id="blog">
        ...
        <h1>Blog Posts</h1>
         ...
         <div className="container-blog">
          ...
          <b style={{ fontWeight: 'bold' }}><span style={{ color: 'rgb(71, 240, 212)', fontSize: '26px', fontWeight: 'bold' }}>Avinash </span>Humber College ,Toronto, Canada</b>
        ...
        <div className="container-blog">
          <img src=""
            alt="Avatar" style={{ width: '90px' }} />
          <b style={{ fontWeight: 'bold' }}><span style={{ color: 'rgb(71, 240, 212)', fontSize: '26px', fontWeight: 'bold' }}>Kartikey </span> University of Sydney, Australia</b>
        ...
        <div className="container-blog">
          <img src="" alt="Avatar"
            style={{ width: '90px' }} />
          <b style={{ fontWeight: 'bold' }}><span style={{ color: 'rgb(71, 240, 212)', fontSize: '26px', fontWeight: 'bold' }}>Amanjyot</span> Langara College ,Vancouver, Canada</b>
...
<h2 style={{ backgroundColor: "#236082", width: '80%', maxWidth: '900px', textAlign: 'center', margin: '0 auto' }}>Upcoming programs of 4Track Learning</h2>
